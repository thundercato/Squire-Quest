...
sqNpc('sq_dungeon_guard','dungeon_cell_1','prison guard',['guard','jailer','gaoler'],'The prison guard has the relaxed confidence of somebody currently on the useful side of the locked door.')
...
sqScenery('sq_dungeon_straw','dungeon_cell_1','straw bed',['straw','hay','bed'],'A pile of prison straw offers all the support of a landlord’s promise.')
sqScenery('sq_dungeon_water','dungeon_cell_1','dripping water',['water','drip','leak'],'Water drips steadily from the stonework.')
sqScenery('sq_dungeon_wall','dungeon_cell_1','loose stonework',['wall','stonework','stones','stone','west wall'],function(){ return sq.wallOpen ? 'A rough opening now leads through the west wall.' : 'The west wall has suspiciously loose stonework.' })
sqScenery('sq_dungeon_vent','dungeon_cell_1','barred vent',['vent','bars','grille','grill'],function(){ return sq.ventOpen ? 'The bars have been spread far enough to squeeze through.' : 'A small barred vent sits high in the wall.' })
sqScenery('sq_dungeon_skeleton','dungeon_cell_2','skeleton',['bones','corpse','dead prisoner'],'A chained skeleton slumps in the neighbouring cell.')
sqScenery('sq_dungeon_rat','dungeon_cell_2','rat',['rats'],'A rat peers from a hole with weary local-resident contempt.')
